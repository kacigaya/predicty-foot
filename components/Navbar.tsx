    ...
    <header className="sticky top-0 z-40 px-4 pt-3 sm:pt-4">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between rounded-2xl border border-border bg-background/80 px-4 py-2.5 shadow-xs backdrop-blur-md sm:px-5 sm:py-3">
        <div className="flex items-center gap-3">
          <Link
            href="/"
            className="rounded-md font-heading text-xl font-bold leading-none tracking-tight text-foreground transition-opacity hover:opacity-85 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring sm:text-2xl"
          >
            <span translate="no">
              Predicty
